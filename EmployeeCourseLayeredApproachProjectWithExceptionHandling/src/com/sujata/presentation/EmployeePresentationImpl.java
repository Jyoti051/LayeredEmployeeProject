...
public class EmployeePresentationImpl implements EmployeePresentation {
	...
	try {
		...
		case 3:
			...
			System.out.println("Enter Employee ID to deregister for a course ");
			int eId=scanner.nextInt();
			System.out.println("Enter Course ID to deregister for a course ");
			String c1Id=scanner.next();
			if(courseService.deregisterEmployeeForCourse(eId,c1Id))
